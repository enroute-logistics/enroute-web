...
Ext.define("Traccar.view.edit.UsersController", {
  ...
  init: function () {
    ...
    this.lookupReference("userCommandsButton").setHidden(
      Traccar.app.getPreference("limitCommands", false)
    );
    this.lookupReference("userMaintenancesButton").setHidden(
      Traccar.app.getVehicleFeaturesDisabled() ||
        Traccar.app.getBooleanAttributePreference("ui.disableMaintenance")
    );
  },
  ...
  onSelectionChange: function (selection, selected) {
    ...
    this.lookupReference("userUsersButton").setDisabled(
      disabled || selected[0].get("userLimit") === 0
    );
